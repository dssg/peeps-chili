...
def setup_experiment(experiment_config_file):
    ...
    project_folder = os.path.join(data_folder, 'elsal_new', 'decoupled_overage_1')
    print("="*10)
...
def visualize_timechop(config_file):
    ...
    data_folder = '/mnt/data/experiment_data/elsal/timechops'
    
    save_path = os.path.join(data_folder, 'elsal_09_13')
