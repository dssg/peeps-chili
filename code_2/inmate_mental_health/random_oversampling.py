...
def copy_test_yaml(conn, orig_data_dir, dest_data_dir, experiment_hash, ratio, N):
    ...
    for in_file in os.listdir(os.path.join(orig_data_dir)):
        if(in_file.endswith("yaml")):
            for i in range(N):
                print("Copying:"+str(os.path.join(orig_data_dir,in_file))+" TO "+str(os.path.join(dest_data_dir, 'oversampled_random_'+str(i))))
...
if __name__ == '__main__':
    ...
    dest_data_dir = os.path.join(DATA_DIR, 'joco_oversampled_race')
