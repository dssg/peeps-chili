...
def ra_procedure(weights=[0.99, 0.01], demo_col="ovg", working_schema="bias_analysis_temp", results_schema="bias_analysis", list_size=10_000, alternate_save_names=[], engine_donors=None, config=None, pause_phases=False, exhaustive=False, entity_selection=False, small_model_selection=False):
    ...
    common_params = {"pg_role": config["user"], "schema": working_schema, "experiment_hashes": ['1389879cda302717c1e258fefa6ea1a9','273fba59016d9ac39f25d5c654866c2d', '41c9ca9094772dbb886db530f7988cb6', '58669c16e9e0054273346eefa313922d', 'af0453996be5ae6ee2bcfbc145a8dca6', 'de9c7c65bf2f49252abfd1e89d4b9e7c', 'fb8fa78e0fc7c1ab9f21f2536091d9a3'], 'demo_col': demo_col, "subsample": False, "bootstrap": False, "entity_demos":f'{working_schema}.entity_demos', "list_sizes": [list_size], "date_list": date_list}
